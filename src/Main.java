        ...
        while (av=true) {
            ...
            if (menu == 3) {
                ...
                do {
                    ...
                    if (tipo == 2){
                        ...
                        Boolean revisar = Leer.leerBoolean("Tiene la revision pasada? true/false ");
                        boolean[] revisiones = new boolean[]{false, false, false, false, false};
                        int km = Leer.leerEntero("Cuantos km tiene? ");
                        int años = Leer.leerEntero("Cuantos años tiene? ");
                        Coche2mano coche2 = new Coche2mano(bastidor, matricula, marca, color, modelo, precio, revisar, revisiones, km, años);
            ...
            if (menu == 4) {
                if (vehiculos.isEmpty()) {
                    ...
                    int elim = Leer.leerEntero("Que vehiculo quieres eliminar? ");
                    vehiculos.remove(elim);
                }
            }
            if (menu == 5) {
                if (vehiculos.isEmpty()) {
